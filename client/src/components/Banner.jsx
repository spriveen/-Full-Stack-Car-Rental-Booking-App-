...
const Banner = () => {
  ...
  <div className='text-white'>
    ...
    <p className='mt-2'>Monetize your vehical effortlessly by listning it on Car Rental</p>
    <p className='max-w-130'>We take care of insurance,driver verfication and secure payments so you can
