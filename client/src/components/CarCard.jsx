...
const CarCard = ({car}) => {
  ...
  return (
    <div onClick={()=>{navigate(`/car-details/${car._id}`);scrollTo(0,0)}} className='group-ronded-xl overflow-bhidden shadow-lg hover:translate-y-1
    transition-all duration-500 curor-pointer'>
