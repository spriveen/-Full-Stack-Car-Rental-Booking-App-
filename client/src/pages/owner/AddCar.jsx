        ...
        <div className='grid grid-col-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
          ...
          <div className='flex flex-col w-full'>
            ...
            <input
              ...
              required
              className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none'
              value={car.setting_capacity}
              onChange={(e) => setCar({ ...car, setting_capacity: e.target.value })}
            />
          </div>
          </div>
          {/* Cr location */}
          <div className='flex flex-col w-full'>
            ...
            <textarea rows={5}
              ...
              placeholder='e.g. luxurious SUV with a spacious interior and a powerfull engine.'
              required
              className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none'
